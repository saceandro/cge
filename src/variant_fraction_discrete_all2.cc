      ...
      for (int _t = 1; _t <=T_MAX; ++_t)
        {
          ...
          string outf = "./variant_fraction_discrete_all2_data/variant_fraction_discrete_all2_h0_betatilda" + to_string(beta_tilda_disc) + "_t" + to_string(_t);
          ofstream ff(outf);
          ...
          for (int _t_h = 0; _t_h<T_H_MAX; ++_t_h)
            {
              ...
              string outf2 = "./variant_fraction_discrete_all2_data/variant_fraction_discrete_all2_h1_t" + to_string(_t) + "_t_h" + to_string(_t_h);
              ofstream ff2(outf2);
